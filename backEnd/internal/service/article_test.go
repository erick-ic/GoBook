...
//go:generate mockgen -source=../repository/article/article_author.go -package=articlerepomocks -destination=../repository/article/mocks/article_author.mock.go
//go:generate mockgen -source=../repository/article/article_reader.go -package=articlerepomocks -destination=../repository/article/mocks/article_reader.mock.go
