...
// Source: ../repository/article/article_reader.go
//
// Generated by this command:
//
//	mockgen -source=../repository/article/article_reader.go -package=articlerepomocks -destination=../repository/article/mocks/article_reader.mock.go
//
