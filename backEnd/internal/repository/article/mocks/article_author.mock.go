...
// Source: ../repository/article/article_author.go
//
// Generated by this command:
//
//	mockgen -source=../repository/article/article_author.go -package=articlerepomocks -destination=../repository/article/mocks/article_author.mock.go
//
