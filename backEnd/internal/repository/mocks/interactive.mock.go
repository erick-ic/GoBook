...
//
//	mockgen -source=internal/repository/interactive.go -package=repomocks -destination=internal/repository/mocks/interactive.mock.go InteractiveRepository
//
...
func (m *MockInteractiveRepository) AddCollectItem(ctx context.Context, biz string, id, cid, uid int64) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "AddCollectItem", ctx, biz, id, cid, uid)
	ret0, _ := ret[0].(error)
	return ret0
}

// AddCollectItem indicates an expected call of AddCollectItem.
func (mr *MockInteractiveRepositoryMockRecorder) AddCollectItem(ctx, biz, id, cid, uid any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "AddCollectItem", reflect.TypeOf((*MockInteractiveRepository)(nil).AddCollectItem), ctx, biz, id, cid, uid)
}
...
func (mr *MockInteractiveRepositoryMockRecorder) BatchIncrReadCnt(ctx, biz, bizId any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockInteractiveRepositoryMockRecorder) Get(ctx, biz, id any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
