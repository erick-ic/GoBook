...
func TestInteractiveDAO_InsertLikeInfo(t *testing.T) {
	testCases := []struct {
		name        string
...
func TestInteractiveDAO_InsertCollectBiz(t *testing.T) {
	testCases := []struct {
		name        string
		prepare     func(sqlmock.Sqlmock)
		wantChanged bool
...
func TestInteractiveDAO_DeleteLikeInfo(t *testing.T) {
	testCases := []struct {
		name        string
		prepare     func(sqlmock.Sqlmock)
		wantChanged bool
...
func TestInteractiveDAO_BatchIncrReadCnt(t *testing.T) {
